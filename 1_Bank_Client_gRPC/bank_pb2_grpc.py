...
class createStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MsgDelivery = channel.unary_unary(
                '/bank.create/MsgDelivery',
                request_serializer=bank__pb2.clientRequest.SerializeToString,
...
def add_createServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'MsgDelivery': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=bank__pb2.clientRequest.FromString,
...
class create(object):
    ...
    def MsgDelivery(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bank.create/MsgDelivery',
            bank__pb2.clientRequest.SerializeToString,
